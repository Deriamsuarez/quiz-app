...
const steps = [
  { id: '01', name: 'Multiple Choice', href: '#', status: 'complete' },
  { id: '02', name: 'Order the sentence', href: '#', status: 'complete' },
  { id: '03', name: 'Listen and write', href: '#', status: 'current' },
  { id: '04', name: 'Fill in the blanks', href: '#', status: 'upcoming' },
...
const Steps = () => {
  return (
    <nav aria-label="Progress">
      <ol role="list" className="divide-y divide-gray-300 rounded-md border border-gray-300 md:flex md:divide-y-0 overflow-x-scroll ">
